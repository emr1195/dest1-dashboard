  ...
  return (
    <div className="flex w-full flex-col gap-3 xl:flex-row xl:items-center xl:justify-end">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
        ...
        <select id="tasks-category" value={category} onChange={(event) => updateParams({ category: event.target.value })} className="h-11 rounded-xl border border-[var(--border-default)] bg-white px-3 text-sm outline-none focus:border-[var(--primary)] focus:ring-4 focus:ring-[var(--focus-ring)]">
        ...
        <select id="tasks-status" value={status} onChange={(event) => updateParams({ status: event.target.value })} className="h-11 rounded-xl border border-[var(--border-default)] bg-white px-3 text-sm outline-none focus:border-[var(--primary)] focus:ring-4 focus:ring-[var(--focus-ring)]">
